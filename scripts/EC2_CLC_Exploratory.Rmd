...
```
```{r cleaning data, warnings=FALSE}
...
Hmm, wondering if I have enough data to try random forest? Probably not going to work...
```{r random forest trying out}
...
```{r data extracting in other crs}
